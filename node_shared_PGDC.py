...
def main():
    ...
    parser.add_argument('--output',type=str,default='/root/rlap-main_fe_gnn/cancer_Net/PathNet/Result/predicted_scores_UCEC_PathNet.txt',help='/root/rlap-main_fe_gnn/cancer_Net/PathNet/Result/predicted_scores_BLCA_PathNet.txt')
    ...
    parser.add_argument('--dataset_file', type=str, default='/root/rlap-main_fe_gnn/cancer_Net/PathNet/PathNet_UCEC_ten_5CV.pkl',
    ...
    pre_res.to_csv(path_or_buf=args.output, sep='\t', index=True, header=True)
